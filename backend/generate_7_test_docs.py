...
doc2.add_paragraph('FR-102: The system shall process member book borrowing, calculate overdue fines daily, and handle payment settlement through integrated payment gateway.')
...
doc2.add_paragraph('FR-104: The system shall notify member via email when reserved copy becomes available and export circulation reports.')
...
doc3.add_paragraph('FS-204: Report and notification engine sends email after reserved copy becomes available and formats circulation tables.')
...
doc4.add_paragraph('US-304: As a Member, I want to receive an email notification when my reserved book becomes available so that I can pick it up.')
...
doc5.add_paragraph('TC-405: Test Scenario: Reserved Copy Email Dispatch. Verify member receives email notification when reserved book copy becomes available.')
...
doc6.add_paragraph('CR-505: Add push notifications in addition to email when reserved book copy becomes available.')
